...
if (gulpVersion == 3) {
	...
	gulp.task('watch', taskArr, function() {
		...
		gmWatch && gulp.watch('src/img/_src/**/*', ['img']);
	});
...
if (gulpVersion == 4) {
	...
	gulp.task('watch', function() {
		...
		gmWatch && gulp.watch('src/img/_src/**/*', gulp.parallel('img')); // GraphicsMagick watching image sources if allowed.
	});
